...
function translate() {
	document.getElementById('morse').value = morse.encode(document.getElementById('english').value);
	document.getElementById('english2').value = morse.decode(document.getElementById('morse2').value);
}
